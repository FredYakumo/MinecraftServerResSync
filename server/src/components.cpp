...
namespace components {
    ...
    void get_resource_list(const request &req, response &response, std::unordered_map<std::string_view, std::string_view> param_map) {
    ...
    void fetch_resource(const request &req, response &response, std::unordered_map<std::string_view, std::string_view> param_map) {
        boost::json::array ret{};
